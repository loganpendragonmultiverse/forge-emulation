...
| bsnes | SNES | 115 | GPL-3.0-or-later | `libretro/bsnes-libretro` at `6d19eef5835a792e241e33194b4c1e9b75405b88` |
...
The buildbot archives were captured on 2026-08-27. Nestopia and SameBoy expose their source commit in their runtime version string. The bsnes and BlastEm snapshots record the upstream core repository head that preceded the captured build and had no later commit at capture time.
